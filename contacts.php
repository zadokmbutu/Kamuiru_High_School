...
<div class="container">
   <div class="contact-section">
        <div class="contact-info">
            ...
            <p>
                <i>📍</i>
                <strong>Address:</strong> P.O. Box 123, Kamuiru, Kenya
            </p>
            
            <p>
                <i>📞</i>
                <strong>Phone:</strong> <a href="tel:+254799520412">+254 799 520412</a>
            </p>
            
            <p>
                <i>✉️</i>
                <strong>Email:</strong> <a href="mailto:info@Kamuiruhigh.sc.ke">info@Kamuiruhigh.sc.ke</a>
            </p>
        </div>
